...
const STEPS = [
  "Embedding brand profile",
  "Indexing colleges & regions",
  "Scanning student social graph",
...
export default function MatchingLoader() {
  ...
  const nextPath = useMemo(() => search.get("next") || "/brands/recommendations", [search]);
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-3xl px-6 pt-24 pb-24">
          <div className="text-center">
            ...
            <h1 className="mt-8 text-2xl md:text-3xl font-semibold tracking-tight">Finding the right student ambassadors…</h1>
            <p className="mt-2 text-white/70">We’re calibrating your brand and scanning campus networks. This usually takes a few seconds.</p>
          </div>
